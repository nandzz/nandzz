...
export function StaffEditor({
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <ArrowLeft className="h-4 w-4" /> {t.booking.backToTeam}
      </button>
      ...
      <section className="rounded-2xl border border-border bg-background p-5 space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
          <button
            ...
            disabled={uploading}
            aria-label={t.booking.changePhotoAria.replace("{name}", staff.name || t.booking.unnamedStaff)}
          ...
          <div className="flex flex-1 flex-col gap-3">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                placeholder={t.booking.roleBioPlaceholder}
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end border-t border-border pt-4">
          ...
          >
            <Trash2 className="h-4 w-4" /> {t.booking.deleteStaffMember}
          </Button>
        </div>
      </section>
    </div>
